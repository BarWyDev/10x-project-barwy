...
export function UsageLimitIndicator({ usageInfo, className }: UsageLimitIndicatorProps) {
  const percentage = calculateUsagePercentage(usageInfo.total_generated_today, usageInfo.daily_limit);
  ...
  return (
    <div className={className}>
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-medium text-gray-700">Dzienny limit generowania AI</span>
