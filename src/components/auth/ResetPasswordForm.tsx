...
import type { ResetPasswordFormData } from "@/lib/validation/auth.schemas";
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <Alert className="border-green-200 bg-green-50 text-green-900">
            <p className="text-sm">
              Twoje hasło zostało pomyślnie zmienione. Możesz teraz zalogować się do swojego konta.
            </p>
          </Alert>
        </CardContent>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Minimum 8 znaków, zawiera małą literę, dużą literę i cyfrę</p>
          </div>
