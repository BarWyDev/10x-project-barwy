    ...
    return (
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">Jeśli konto istnieje, instrukcje zostały wysłane</CardDescription>
        </CardHeader>

        <CardContent>
          <Alert className="border-green-200 bg-green-50 text-green-900">
            <p className="text-sm">
              Jeśli podany adres email jest zarejestrowany w naszym systemie, otrzymasz wiadomość z instrukcjami
              resetowania hasła.
            </p>
